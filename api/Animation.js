...
export default class Animation {
    ...
    rotate3d() {
        console.warn('rotate3d are not currently supported')
    }

    scale3d() {
        console.warn('scale3d are not currentlu supported')
    }

    scaleZ() {
        console.warn('scaleZ are not currently supported')
    }

    skewX() {
        console.warn('skewX are not currently supported')
    }

    skewY() {
        console.warn('skewY are not currently supported')
    }

    translate3d() {
        console.warn('translate3d are not currently supported')
    }

    translateZ() {
        console.warn('translateZ are not currently supported')
    }
}